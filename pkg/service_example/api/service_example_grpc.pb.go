...
func (c *pingPongClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
	err := c.cc.Invoke(ctx, "/api_service_example.PingPong/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPingPongServer) Ping(context.Context, *PingRequest) (*Pong, error) {
...
func _PingPong_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api_service_example.PingPong/Ping",
	}
...
var PingPong_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api_service_example.PingPong",
	...
	Metadata: "api/service_example.proto",
}
